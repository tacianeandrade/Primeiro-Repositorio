...
#Use data entry via the keyboard to ask the user to enter two numbers (int or decimal). Your program should perform the addition, subtraction, multiplication, division and square root operations first number entered and then display the result on the screen.
